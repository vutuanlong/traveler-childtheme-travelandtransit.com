	...
	<div class="tab-content" id="myTabContent973">
		<div id="tab-booking-detail" class="tab-pane fade active in">
			<div class="info">
				...
				">
					...
					<!-- End Tour Package -->
				<?php
				echo st()->load_template( 'user/detail-booking-history/detail-price', false,
					[
		...
		<div id="tab-customer-detail" class="tab-pane fade">
			<div class="container-customer">
				<?php echo apply_filters( 'st_customer_info_booking_history', st()->load_template( 'user/detail-booking-history/customer', false, [ 'order_id' => $order_id ] ), $order_id ); ?>
			</div>
		</div>
	</div>
</div>
