...
if ( isset( $item_id ) and $item_id ) :
	...
	// add om custom
	$package_name = isset( $item['data']['package_name'] ) && $item['data']['package_name'] ? $item['data']['package_name'] : '';
		...
		<form method="post" action="<?php the_permalink() ?>">
			...
			<div class="form-group">
				...
				<?php if ( st()->get_option( 'use_woocommerce_for_booking', 'off' ) == 'off' && st()->get_option( 'booking_modal', 'off' ) == 'on' ) { ?>
					...
					<button type="submit" class="btn btn-primary add-coupon-ajax"><?php echo __( 'APPLY', 'traveler-childtheme' ); ?></button>
					<div class="alert alert-danger hidden"></div>
				<?php } else { ?>
					<button type="submit" class="btn btn-primary"><?php echo __( 'APPLY', 'traveler-childtheme' ); ?></button>
				<?php } ?>
			</div>
		</form>
	</div>
