...
$cart_info = get_post_meta($item_id,'st_cart_detail',true);
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_last_name"
                                               value="<?php echo esc_attr($st_last_name); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_email"
                                               value="<?php echo esc_attr($st_email); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_address"
                                               value="<?php echo esc_attr($st_address); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_address2"
                                               value="<?php echo esc_attr($st_address2); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_city"
                                               value="<?php echo esc_attr($st_city); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_province"
                                               value="<?php echo esc_attr($st_province); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_zip_code"
                                               value="<?php echo esc_attr($st_zip_code); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text"
                                               name="st_country"
                                               value="<?php echo esc_attr($st_country); ?>"
                                               class="form-control form-control-admin">
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden"
                                               name="child_number"
                                               value="<?php echo esc_attr($child_number); ?>">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden"
                                               name="infant_number"
                                               value="<?php echo esc_attr($infant_number); ?>">
                                                ...
                                                <?php if (is_array($car_package) && count($car_package)) { ?>
                                                    <table class="table"
                                                        ...
                                                        <?php foreach ($car_package as $key => $number):
                                                            ...
                                                            if ($price_item <= 0) $price_item = 0;
                                                            $number_item = isset($number->qty) ? intval($number->qty):0;
                                                            if ($number_item <= 0) $number_item = 0;
                                                            ?>
                                                            <tr>
                                                                <td width="50%">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <?php if ($coupon_price) { ?>
                                                            <strong>
                                                                - <?php echo TravelHelper::format_money_from_db($coupon_price, $currency); ?></strong>
                                                        <?php } ?>
                                                    </div>
